...
namespace KinematicCharacterController.Examples
{
    public class PlanetManager : MonoBehaviour, IMoverController
    {
        ...
        private List<CharacterController> _characterControllersOnPlanet = new List<CharacterController>();
        ...
        private void Start()
        {
            ...
            player.Motor.SetPositionAndRotation(OnPlanetTeleportingZone.transform.position,
												OnPlanetTeleportingZone.transform.rotation);
			ControlGravity(player);
		}
